        ...
        <div className="container">
          <div className="grid lg:grid-cols-2 gap-20">
            <div className="lg:pr-10">
              ...
              <p className="text-lg text-muted-foreground font-light leading-relaxed">Ce qui m'anime, faire les choses différemment. Fervent combattant de la maxime "On a toujours fait comme ca", je n'hésite pas à essayer d'autres routes, évaluer, corriger, réadapter pour obtenir le résultat escompté.
