...
export default function Performances() {
  return (
    <div className="bg-background min-h-screen pt-24">
      ...
      {/* International Results Section */}
      <section className="py-32 border-b border-white/5">
        <div className="container">
          <div className="mb-16">
            <div className="inline-flex items-center gap-3 mb-8">
              <span className="h-[1px] w-12 bg-accent"></span>
              <span className="text-accent text-xs font-bold uppercase tracking-[0.2em]">Compétitions Récentes</span>
            </div>
            <h2 className="text-4xl md:text-6xl font-heading font-extrabold uppercase tracking-tighter mb-8">
              Résultats <br />
              <span className="text-transparent [-webkit-text-stroke:2px_theme(colors.foreground)] opacity-80">Internationaux.</span>
            </h2>
          </div>

          <div className="bg-secondary/20 border border-white/10 p-8 md:p-12 mb-16">
            <div className="flex items-center gap-4 mb-8">
              <Target className="w-10 h-10 text-accent/50" strokeWidth={1} />
              <div>
                <h3 className="text-2xl font-heading font-bold uppercase tracking-wider">Conquest Cup</h3>
                <p className="text-muted-foreground text-sm">Istanbul, Turquie • 2026</p>
              </div>
            </div>

            <div className="grid md:grid-cols-3 gap-8 text-center mb-12">
              <div className="bg-background border border-white/10 p-6">
                <p className="text-5xl font-heading font-extrabold text-accent mb-3">15th</p>
                <p className="text-xs text-muted-foreground uppercase tracking-widest">Individuel</p>
              </div>
              <div className="bg-background/50 border border-white/5 p-6 opacity-50">
                <p className="text-5xl font-heading font-extrabold text-white/30 mb-3">—</p>
                <p className="text-xs text-muted-foreground uppercase tracking-widest">Équipe</p>
              </div>
              <div className="bg-background/50 border border-white/5 p-6 opacity-50">
                <p className="text-5xl font-heading font-extrabold text-white/30 mb-3">—</p>
                <p className="text-xs text-muted-foreground uppercase tracking-widest">Mixte</p>
              </div>
            </div>

            {/* Photo Gallery */}
            <div className="border-t border-white/5 pt-8">
              <h4 className="text-lg font-heading font-bold uppercase tracking-wider mb-6">Galerie Photo</h4>
              <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
                <div className="relative aspect-[3/4] overflow-hidden border border-white/10 group">
                  <Image
                    src="/SYG6569.jpg"
                    alt="Conquest Cup Istanbul 2026"
                    fill
